            ...
            return (
              <div key={course._id} className="bg-white rounded-[20px] border border-gray-100 shadow-sm overflow-hidden flex flex-col hover:shadow-md transition-shadow group relative">
                ...
                <div className={`h-40 w-full relative p-6 flex flex-col justify-end overflow-hidden ${
                  ...
                  {course.thumbnail ? (
                    <img src={course.thumbnail} alt={course.name} className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity" />
                  ) : (
                    /* Decorative Elements */
                  ...
                  <div className="relative z-10">
                    <h3 className="text-xl font-bold text-gray-900 leading-tight mb-1 drop-shadow-sm break-words">{course.name}</h3>

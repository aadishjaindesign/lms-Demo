...
export default function StudentDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-7xl mx-auto h-full p-8">
      {/* Welcome Banner */}
      <div className="bg-gradient-to-r from-[#c71e22] to-red-900 rounded-[20px] p-10 shadow-sm text-white flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          <h2 className="text-3xl font-bold mb-2">Welcome back, {data?.name}! 👋</h2>
        ...
        <Link 
          ...
          className="bg-white text-[#c71e22] font-semibold px-6 py-3 rounded-full hover:bg-gray-50 transition-colors shadow-sm whitespace-nowrap"
        >
          Go to My Courses
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-[20px] p-8 shadow-sm border border-gray-100 flex items-center gap-6">

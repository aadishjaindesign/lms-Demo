...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden font-sans">
      ...
      {/* Sidebar */}
      <aside className="w-[260px] bg-white border-r border-gray-200 flex flex-col flex-shrink-0 relative">
      ...
      <main className="flex-1 flex flex-col h-full bg-white relative">
        {/* Header */}
        <header className="h-20 border-b border-gray-100 flex items-center justify-between px-8 bg-white flex-shrink-0">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center gap-3 cursor-pointer">
              <div className="w-10 h-10 rounded-full bg-red-100 text-[#c71e22] font-bold flex items-center justify-center text-lg">A</div>
              ...
              <svg className="w-4 h-4 text-gray-500 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg>
            </div>
          </div>
        </header>
        ...
        {/* Footer */}
        <footer className="h-14 border-t border-gray-100 flex items-center justify-between px-8 text-xs text-gray-400 font-medium bg-white flex-shrink-0">
